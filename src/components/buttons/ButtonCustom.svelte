<script>
  ...
  const defaultClasses =
    'inline-block uppercase p-2 px-8 text-center align-middle rounded font-bold tracking-wide transition-all border border-transparent shadow-lg focus:outline-none focus:ring-2 '
