...
<div class={background}>
  <footer class="pb-0 pt-10 lg:pb-2 blue-radial-gradient" class:rounded-t-3xl={rounded}>
    <!-- STANDARD FOOTER -->
    <div class="hidden lg:block container w-4/5 max-w-screen-xl pb-32 mx-auto lg:py-8">
      <div class="flex justify-around py-4 border-b">
        <div class="flex w-2/5 align-middle">
          <a href="/" class="flex items-center mb-4 space-x-3 sm:mb-0 rtl:space-x-reverse">
            <img style="fill: white;" src="/mcswf-badge.svg" class="h-16 text-white" alt="MCSWF Logo" />
      ...
      <div class="flex justify-around py-4 align-middle border-b">
        <div class="w-2/5">
          <a href="/" class="flex items-center mb-4 space-x-3 sm:mb-0 rtl:space-x-reverse">
            <img style="fill: white;" src="/ega-full.svg" class="h-12 text-white" alt="MCSWF Logo" />
          </a>
        </div>
        <div class="w-3/5">
          <p class="font-light">
            Product of The Marine Corps Software Factory, which proudly sits within the <a href={externalLinks.deputyCommandantForInformation} class="underline text-mcswf-gold"
              >Deputy Commandant for Information</a
            >.
          </p>
        </div>
      </div>
      <div class="flex justify-around items-center py-4 mb-8 border-b">
        <div class="w-2/5">
          ...
          <div class="flex justify-start mb-4">
            <a href={externalLinks.social.linkedIn} class="mr-4" target="_blank" rel="noopener noreferrer">
              <LinkedIn size="lg" primary="fill-linkedin-blue" secondary="fill-white" class="rounded-sm" />
            </a>
          </div>
        </div>
        <div class="w-3/5 font-light">
          ...
          <p>
            Email us at <a href={`mailto:${externalLinks.mcswfEmail}?subject=${externalLinks.mcswfEmailSubject}`} class="underline text-mcswf-gold">{externalLinks.mcswfEmail}</a>
          </p>
        </div>
      </div>
      <div class="text-transparent">
        Proudly developed at<a class="underline ps-1" href="https://www.marforres.marines.mil/MIU/">Marine Innovation Unit</a>
      </div>
    </div>
    ...
    <div class="block lg:hidden container w-4/5 max-w-screen-xl pb-32 mx-auto lg:py-8">
      ...
      <div class="flex justify-around p-4 align-middle border-b">
        <a href="/" class="flex items-center mb-4 space-x-3 sm:mb-0 rtl:space-x-reverse">
          <img style="fill: white;" src="/ega-full.svg" class="h-16 text-white" alt="MCSWF Logo" />
        </a>
      </div>
      ...
      <div class="flex justify-start p-[.75rem] text-sm font-light gap-4">
        <a href="https://linkedin.com">
          <Icon class="text-5xl" icon="mdi:linkedin" />
        </a>
      </div>
    </div>
  </footer>
