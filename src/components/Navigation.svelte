...
<header class="antialiased blue-radial-gradient h-20">
  <nav
    class="bg-white blue-radial-gradient border-gray-200 px-4 lg:px-6 py-2.5 bg-gray-800"
  >
    <div class="flex flex-wrap justify-between items-center">
      ...
      <div class="flex items-center lg:order-2">
        <button
          ...
          class="hidden p-2 mr-3 text-gray-600 rounded cursor-pointer lg:inline hover:text-gray-900 hover:bg-gray-100 text-gray-400 hover:text-white hover:bg-gray-700"
        >
          <svg
            class="w-5 h-5"
            aria-hidden="true"
        ...
        <button
          ...
          aria-expanded="true"
          aria-controls="sidebar"
          class="p-2 mr-2 text-gray-600 rounded-lg cursor-pointer lg:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 focus:ring-gray-700 text-gray-400 hover:bg-gray-700 hover:text-white"
        >
          <svg
            class="w-[18px] h-[18px]"
            aria-hidden="true"
