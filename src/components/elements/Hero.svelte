...
<div
  ...
  <div
    class="relative h-[400px] md:h-[550px] bg-gradient-to-t from-stone-950 flex flex-col gap-6 md:gap-14 items-stretch md:items-center justify-end md:justify-center text-left md:text-center mx-auto rounded-b-2xl tracking-wider px-8 pb-12">
    <!-- Title -->
