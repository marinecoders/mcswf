...
<div class={background}>
  <footer class="pb-0 pt-10 lg:pb-2 blue-radial-gradient" class:rounded-t-3xl={rounded}>
    ...
    <div class="hidden lg:block container w-4/5 max-w-screen-xl pb-32 mx-auto lg:py-8">
      ...
      <div class="flex justify-around p-4 border-b">
        <div class="w-2/5">
          ...
          <div class="flex justify-start mb-4">
            <a href="https://linkedin.com" class="mr-4" target="_blank" rel="noopener noreferrer">
      ...
      <div class="flex justify-center pt-4 text-sm font-light">
        Proudly developed at<a class="underline ps-1 text-mcswf-gold" href="https://www.marforres.marines.mil/MIU/">Marine Innovation Unit</a>
      </div>
    </div>
